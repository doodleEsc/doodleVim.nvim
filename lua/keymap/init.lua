...
local plug_map = {
    ...
    ["n|<S-p>"]        = map_cr('Lspsaga preview_definition'):with_noremap():with_silent(),
    ...
    -- Plugin Floaterm
    ["n|ff"]           = map_cu('Lspsaga open_floaterm'):with_noremap():with_silent(),
    ["t|ff"]           = map_cu([[<C-\><C-n>:Lspsaga close_floaterm<CR>]]):with_noremap():with_silent(),
