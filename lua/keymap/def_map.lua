...
def_map.insert = {
	...
	["<C-s>"] = bind.convert_wk_format(map_cmd('<Esc>:lua require("extend.misc").safe_save()<CR>'):with_noremap():with_mode("i"):with_label("Save Session")),
	["<C-q>"] = bind.convert_wk_format(map_cmd('<Esc>:lua require("extend.misc").safe_exit()<CR>'):with_noremap():with_mode("i"):with_label("Save Session And Safe Exit")),
}
...
def_map.visual = {
	["<C-d>"] = bind.convert_wk_format(map_cmd("<cmd>lua require('extend.scroll').scroll_down()<CR>"):with_noremap():with_silent():with_label("Smooth Scroll Down"):with_mode("x")),
	["<C-u>"] = bind.convert_wk_format(map_cmd("<cmd>lua require('extend.scroll').scroll_up()<CR>"):with_noremap():with_silent():with_label("Smooth Scroll Up"):with_mode("x"))
}
