...
return require('packer').startup(function(use)
  ...
  -- LSP AND COMPLETION {
	use {'neovim/nvim-lspconfig', event = 'BufReadPre', config = completion.nvim_lsp}
	...
	use {'hrsh7th/nvim-cmp', event = 'InsertEnter', after={'lspkind-nvim', 'LuaSnip'}, config = completion.nvim_cmp}
