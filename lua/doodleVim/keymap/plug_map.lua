...
plug_map.normal = {
    ["t"] = {
        name = "Tree,Translate",
        t = bind.convert_wk_format(map_cr("lua require('doodleVim.extend.tree').toggle()"):with_noremap():with_silent():
    ...
    ["f"] = {
        ...
        r = bind.convert_wk_format(map_cr('FloatermNew --cwd=<root>'):with_noremap():with_silent():with_label("Open Floaterm In Project Rood Dir")),
        v = bind.convert_wk_format(map_cr('FloatermNew --cwd=<buffer>'):with_noremap():with_silent():with_label("Open Floaterm In CWD")),
    ...
    ["<leader>f"] = {
        ...
        l = bind.convert_wk_format(map_cr('Telescope buffers'):with_noremap():with_silent():with_label("Buffers Navigation"))
    },
    ...
    ["<leader>n"] = {
        ...
        u = bind.convert_wk_format(map_cr("lua require('doodleVim.extend.misc').toggle_nu()"):with_noremap():with_silent()
...
plug_map.visual = {
    ["g"] = {
        ...
        f = bind.convert_wk_format(map_cu("lua vim.lsp.buf.formatting()"):with_noremap():with_silent():with_label("Selected Code Formatting")
            :with_mode("v")),
        a = bind.convert_wk_format(map_cu("lua vim.lsp.buf.range_code_action()"):with_noremap():with_silent():with_label("Range Code Action")
            :with_mode("v")),
        n = bind.convert_wk_format(map_cr("lua require('rename').rename()"):with_noremap():with_silent():with_label("Rename")
            :with_mode("v"))
    },
    ...
    ["<C-Space>"] = bind.convert_wk_format(map_cmd("<Cmd>lua require('doodleVim.extend.misc').toggle_whichkey()<CR>"):
        with_noremap():with_label("Show Keymaps"):with_mode("v"))

}

plug_map.insert = {
    ["<C-Space>"] = bind.convert_wk_format(map_cmd("<Cmd>lua require('doodleVim.extend.misc').toggle_whichkey()<CR>"):
        with_noremap():with_label("Show Keymaps"):with_mode("i")),
}
