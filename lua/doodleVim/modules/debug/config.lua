...
function config.dap()
    ...
    vim.fn.sign_define('DapBreakpoint', { text = icons.dap.breakpoint, texthl = 'GruvboxRedSign', linehl = '', numhl = '' })
    ...
    vim.fn.sign_define('DapLogPoint', { text = icons.dap.log_point, texthl = 'GruvboxYellowSign', linehl = '', numhl = '' })
