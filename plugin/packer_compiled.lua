...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-tabnine", "cmp-vsnip", "friendly-snippets", "vim-vsnip", "vim-vsnip-integ" },
